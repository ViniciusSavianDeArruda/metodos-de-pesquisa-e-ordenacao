...
class Util {
    ...
    public static void popular(List<Processo> lista, int quantidade) {
        ...
        for (int i = 0; i < quantidade; i++) {
            ...
            lista.add(
                new Processo(
                    gerador.nextInt(100, 500),
                    "gerando uma string " + gerador.nextInt(quantidade)
                )
            );
        }
    }
...
public class OrdenaListaObjetos {
    ...
    public static void main(String[] args) {
        ...
        // Ordenar a lista de processos usando o id
